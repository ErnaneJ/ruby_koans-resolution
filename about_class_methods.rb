...
class AboutClassMethods < Neo::Koan
  ...
  def test_objects_have_methods
    fido = Dog.new
    assert fido.methods.size > 0 # nao seria 65 ????
  end

  def test_classes_have_methods
    assert Dog.methods.size > 0 # nao seria 219 ????
  end
  ...
  # A primeira forma por ser mais explicita. O primeiro e um pouco estranho para mim.
