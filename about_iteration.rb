...
class AboutIteration < Neo::Koan
  ...
  # - I'm running koans with Ruby in its 3.0.0 version
    def as_name(name)
      name.to_sym
    end
  ...
  def test_inject_will_blow_your_mind
    ...
    # Acumula os valores do array de acordo com o que for passado, ou nao, por parametro. 
    # Pode receber um bloco de codigo, ou nao.
  end
  ...
  #   end
  #
  # Why did we do it that way instead of the following? Para economisar memoria
  #
