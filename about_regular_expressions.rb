...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # THINK ABOUT IT:
    #
    # When would * fail to match? Stiver algo antes e depois dela que não corresponda. Ex: /z*b/
  end
  ...
  # Segundo a documentacao, a repetição é gananciosa por padrão: tantas ocorrências quanto possível são correspondidas, 
  # embora ainda permitindo que a correspondência geral seja bem-sucedida. 
  # Por outro lado, a correspondência preguiçosa torna a quantidade mínima de correspondências necessária para o sucesso geral.
  ...
  # R: Enquanto, por exemplo, (.|\n) corresponde a qualquer caractere, [.\n] corresponde a um ponto literal ou a uma nova linha.
