...
class AboutMethods < Neo::Koan
  ...
  def test_sometimes_missing_parentheses_are_ambiguous
    ...
    #   assert_equal(5, my_global_method(2), 3)
    # or
    #   assert_equal(5, my_global_method(2, 3)) ✔️
    #
  ...
  # Antes do Ruby 2.7, chamar um método privado com self gerava uma exceção NoMethodError. 
  # A partir de 2.7, isso agora é permitido
